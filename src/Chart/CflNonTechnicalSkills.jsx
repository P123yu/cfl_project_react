...
const CflNonTechnicalSkills = () => {
  const location = useLocation();
  const particularCflData = location?.state?.data?.nonTechnicalSkills;
  console.log(particularCflData, "particularCflData");
...
export default CflNonTechnicalSkills;
