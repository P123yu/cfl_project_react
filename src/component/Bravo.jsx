...
import BravoImage from "../image/MainBravo.png";
...
function Bravo() {
  ...
  const handleChooseMgrTemplate = () => {
    if (
      category !== "" &&
      rewardedPersonName !== "" &&
      rewardedMessage !== ""
    ) {
      navigate("/mgr-template", {
        state: {
          data1: category,
  ...
  return (
    <div className="cms-dashboard">
      <div className="grid grid-cols-2">
        <div className="col">
          <img src={BravoImage} style={{ height: "100vh" }} />
        </div>
          ...
          <div className="thanks-form bg-yellow-200 p-20 w-[480px] ml-16  rounded-xl border-2 border-gray-600">
            ...
            <div className="template">
              <button
                ...
                onClick={handleChooseMgrTemplate}
              >
                Choose Template
              </button>
            </div>
