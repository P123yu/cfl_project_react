...
function ManagerFeedback() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/managerToCflFeedBack/get")
  ...
  const filteredCfl = flattenedArray.filter((item) => {
    ...
    return (
      (!month || feedbackMonth === month) && (!year || feedbackYear === year)
    );
  });
      ...
      <div className="bg-gray-100 pt-5 rounded-2xl">
        ...
        {filteredCfl.length > 0 ? (
            ...
            <div key={index}>
              <VerticalTimeline lineColor="blue">
                ...
                >
                  ...
                  <h3 className="vertical-timeline-element-title">
                    <div className="flex items-center space-x-5">
                      <label className="text-lg">Manager Name =</label>
                      <p className="" style={{ marginTop: "-2px" }}>
                        {item.managerName}
                      </p>
                    </div>
                  ...
                  <h4 className="vertical-timeline-element-subtitle mt-2">
                    <div className="flex items-center space-x-5">
                      <label className="text-md ">Manager's Feedback = </label>
          ...
          <p className="text-center text-lg">
            No feedbacks available for the selected month and year.
          </p>
        )}
      </div>
    </div>
